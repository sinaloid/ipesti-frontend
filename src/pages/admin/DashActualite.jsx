    ...
    <>
      <div className="row mb-3">
        <div className="col-12">
          <h1 className="text-start mb-3">Liste des actualites</h1>
              ...
              {[...Array(8).keys()].map((data, idx) => {
                return (
                  <tr key={idx}>
                    ...
                    <td>
                      <span>Sanou Ali</span><br />
                      <span className="text-muted fs-14">Secretaire</span>
                    </td>
                    <td>
                    Festival de l’Histoire des Science et des Techniques Burkina Faso 2023
                    </td>
                    <td>12/12/2023</td>
