    ...
    <>
      <div className="row mb-3">
        <div className="col-12">
          <h1 className="text-start mb-3">Pages</h1>
            ...
            <div className="col mb-3" key={idx}>
              <div className="card">
                ...
                <img
                  width={"100%"}
                  src={
                    "https://source.unsplash.com/random/800x800/?site=" + idx
                  }
                />
                </div>
                <div className="p-2">
                <span className="d-block fs-18 text-start">Nom de la page</span>
                <span className="d-block fs-10 text-start">
                  Nom de la catégorie
                </span>
                <span className="d-block fs-18 text-start">Nom de l'auteur</span>
                <div className="d-flex">
